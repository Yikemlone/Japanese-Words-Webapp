...
function main() {
    ...
    container.innerHTML = `<div class="phase-1"> <div class="text-container"> <p>How many words do you want to learn?</p> </div> <input type="text" name="word-goal" autocomplete="off"></div>`;

    // !!! May use this regex
    // ? /\d{4}-(?:0[1-9]|1[0-2])-(?:0[1-9]|[1-2]\d|3[0-1])/

    $("#date-to-finish").datepicker({
        dateFormat: "yy-mm-dd"
    });
...
// ! May not use this, too complicated and feel bad about it.
    ...
    const calendarControl = {
      ...
      plotSelectors: function () {
        document.querySelector(
          ...
          <div class="calendar-prev"><svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128"><path fill="#666" d="M88.2 3.8L35.8 56.23 28 64l7.8 7.78 52.4 52.4 9.78-7.76L45.58 64l52.4-52.4z"/></svg></a></div>
          <div class="calendar-year-month">
          <div class="calendar-month-label"></div>
          <div>-</div>
          <div class="calendar-year-label"></div>
          </div>
          <div class="calendar-next"><svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128"><path fill="#666" d="M38.8 124.2l52.4-52.42L99 64l-7.77-7.78-52.4-52.4-9.8 7.77L81.44 64 29 116.42z"/></svg></a></div>
          </div>
